	  ...
	  <div class="col-md-3">
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url(); ?>adminika/set_notifikasi/" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label>Pilih Alumni</label>
                  <select  id="alumni" name ="alumni" class="form-control select" style="width: 100%;" required>
				<option <?php if($id_alumni!='') {echo "selected";}?> value="<?php echo $id_alumni; ?>" >
					<?php foreach($listAlumni as $f){
					  if($id_alumni==$f->id_alumni){
						  echo $f->namaAlumni;
					  }
					}
				  ?>
				...
				?>
				  ...
				  ?>
				  <option value="<?php echo $f->id_alumni; ?>" ><?php echo $f->namaAlumni; ?></option>
