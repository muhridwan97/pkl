	  ...
	  <div class="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form action="<?php echo base_url(); ?>biodata/edit_biodata/" method="post" enctype="multipart/form-data">
              <div class="box-body">
			  ...
			  <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name = "noTelpon" value="<?php echo $noTelepon ?>" required
			  ...
			  <input type="hidden" class="form-control" name = "id" value="<?php echo $id_alumni ?>" >
