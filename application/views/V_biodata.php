            ...
            <form action="<?php echo base_url(); ?>biodata/set_biodata/" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama" value="<?php echo $namaAlumni ?>" name="nama" placeholder="Masukkan nama">
                </div>
				<div class="form-group">
                  <label >NIM</label>
                  <input type="number_format" class="form-control" id="nim" value="<?php echo $nim ?>" name="nim" placeholder="Masukkan NIM">
                </div>
				<div class="form-group">
                  <label >Tempat lahir</label>
                  <input type="text" class="form-control" id="tempatLahir" value="<?php echo $tempatLahir ?>" name="tptLahir" placeholder="Masukkan tempat lahir">
                </div>
				<div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  value="<?php echo $tanggalLahir ?>" id="datepicker" name="tglLahir">
                </div>
				</div>
				...
				<br></br>
                  <input type="radio" name="jenisKelamin" class="minimal" value="Pria" <?php if($jenisKelamin=="Pria") {echo "checked";}?>>
				<label>
                  Pria
                </label>
                  <input type="radio" name="jenisKelamin" class="minimal" value="Wanita" <?php if($jenisKelamin=="Wanita") {echo "checked";}?>>
                <label>
                  Wanita
                </label>
              </div>
                ...
                <select name ="golonganDarah" value ="A" class="form-control select" style="width: 100%;">
			  ...
			  <div class="form-group">
                ...
                <select id="strataPendidikan" name ="strataPendidikan" value ="S1" class="form-control select" style="width: 100%;">
			  ...
			  <div class="form-group">
                ...
                <select  id="fakultas" name ="fakultas" class="form-control select" style="width: 100%;">
			  ...
			  <div class="form-group">
                <label>Jurusan</label>
                <select id="jurusan" name ="jurusan" class="form-control select" style="width: 100%;">
				<option <?php if($jurusan!=null) {echo "selected";}?> value="<?php echo $jurusan_id; ?>"><?php echo $jurusan ?></option>
                </select>
              </div>
			  <div class="form-group">
                <label>Program Study</label>
                <select id="programStudi" name ="programStudi" class="form-control select" style="width: 100%;">
			  ...
			  <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right"  value="<?php echo $thnLulus ?>" id="datepicker2" name="thnLulus">
                </div>
				</div>
				<div class="form-group">
				 ...
				 <div class="form-group">
				<label>Tanggal mulai kerja <span style="color:grey;">(12/31/1990)</span>:</label>
                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="text" class="form-control pull-right"  value="<?php echo $thnKerja ?>" id="datepicker3" name="thnKerja">
                </div>
				</div>
			  <div class="form-group">
                  <label>Alamat asal</label>
                  <textarea name="alamat" class="form-control" rows="3"  placeholder="Masukkan ..."><?php echo $alamat ?></textarea>
                </div>
			  <div class="form-group">
